...
export default function EmailAdminPage() {
  ...
  const [emailType, setEmailType] = useState<'campaign' | 'followup'>(
    'campaign',
  )
      ...
      <div className="flex gap-3 border rounded-lg p-3 bg-muted/40">
        <label className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            onChange={(e) =>
              setEmailType(e.target.value as 'campaign' | 'followup')
            }
        ...
        {emailType === 'campaign' ? (
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              onChange={(e) => {
                setFollowupTarget(
                  e.target.value as 'all-customers' | 'workshop-orders',
                )
                setSelectedWorkshop('')
              }}
              className="border rounded-lg px-3 py-2 text-sm bg-background"
